...
//si un organisme et un seul doit être retourné	
	...
	$nb = pg_numrows($result);
		...
		while ($val = pg_fetch_assoc($result)){
			...
			$uuid_organisme = $val['uuid_organisme'];
			...
			$text = "{id_organisme:".$id_organisme.",uuid_organisme:'".$uuid_organisme."',nom_organisme:'".$nom_organisme."',adresse_organisme:'".$adresse_organisme."',cp_organisme:'".$cp_organisme."',ville_organisme:'".$ville_organisme."',tel_organisme:'".$tel_organisme."',fax_organisme:'".$fax_organisme."',email_organisme:'".$email_organisme."'}";
            $json = $json.$text;
			$i++;
			if ($i > 0 and $i!=$nb) {
				$json = $json. ",";
	...
	if($form){
			echo "{success: true, data:{id_organisme:".$id_organisme.",uuid_organisme:'".$uuid_organisme."',nom_organisme:'".$nom_organisme."',adresse_organisme:'".$adresse_organisme.",cp_organisme:'".$cp_organisme.",ville_organisme:'".$ville_organisme.",tel_organisme:'".$tel_organisme.",fax_organisme:'".$fax_organisme.",email_organisme:'".$email_organisme."'}}";
		}
	else{
		echo $json;
	}
