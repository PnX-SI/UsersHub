...
CREATE OR REPLACE VIEW v_usersaction_forall_gn_modules AS
WITH p_user_tag AS (
         SELECT u.id_role,
            u.identifiant,
            u.nom_role,
 ...
 SELECT v.id_role,
   ...
   FROM (SELECT a1.id_role,
     ...
     JOIN utilisateurs.t_tags t1 ON t1.id_tag = v.id_tag_action
     JOIN utilisateurs.t_tags t2 ON t2.id_tag = v.id_tag_object
    )
 SELECT v.id_role,
    v.identifiant,
    v.nom_role,
