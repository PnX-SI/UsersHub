...
from app.models import (
    TTags, BibTagTypes, TApplications, CorRoleTag,
    TRoles, CorOrganismeTag, Bib_Organismes, CorApplicationTag
)
...
def tags():
    ...
    return render_template(
        ...
        table=tab,
        key='id_tag',
        pathU=config.URL_APPLICATION + '/tag/update/',
        pathD=config.URL_APPLICATION + '/tags/delete/',
        pathA=config.URL_APPLICATION + '/tag/add/new',
        pathP=config.URL_APPLICATION + "/tag/users/",
        pathO=config.URL_APPLICATION + "/tag/organisms/",
        pathApp=config.URL_APPLICATION + "/tag/applications/",
        name="un tag",
        name_list="Tags",
        ...
        ID_ACTION=config.ID_ACTION,
        ID_PRIVILEGE=config.ID_PRIVILEGE,
...
def tag_users(id_tag):
    ...
    return render_template(
        ...
        table2=users_in_tag,
        group='groupe',
        info="Tag '" + tag['tag_name'] + "' sur les utilisateurs et les groupes"
     )
...
def tag_organismes(id_tag):
    ...
    return render_template(
        ...
        fLine=header,
        data=data,
        table=organismes_out_tag,
        table2=organismes_in_tag,
        info="Tag '" + tag['tag_name'] + "' sur les organismes"
    )
