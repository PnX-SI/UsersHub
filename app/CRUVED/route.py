...
def CRUVED():
    ...
    if request.method == 'GET':
        return render_template(
            ...
            table=data,
            key='id_role',
            pathC=config.URL_APPLICATION + '/CRUVED/user/',
            pathU='',
            group='groupe',
            name_list='Utilisateurs et Groupes'
        )
...
def cruved_one(id_role):
    ...
    return render_template(
        ...
        tableCruved=contents,
        key='id_role',
        key_app='id_application',
        id_r=role['id_role'],
        pathC='',
        pathU=config.URL_APPLICATION + '/CRUVED/update/',
        pathUu='/',
        pathA=config.URL_APPLICATION + '/CRUVED/add/new/',
        group='groupe',
        name_list='Liste d\'Utilisateurs et de Groupes',
        name_role=role['full_name']
    )

# @route.route('CRUVED/add/new',
#  defautls={'id_role':None,'id_application':None}, methods=['GET','POST'])
