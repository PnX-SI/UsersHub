...
def organismes():
    ...
    return render_template('affichebase.html', table = contenu, entete = entete,ligne = colonne, cheminM = '/bib_organismes/organismes/', cle= 'id_organisme', cheminS = '/bib_organismes/organismes/delete/')
...
def organismes_unique(id_organisme):
    ...
    if request.method == 'POST':
        if form.validate_on_submit() and form.validate() :
            ...
            flash(form.errors)
    return render_template('organisme.html', form = form, nom_organisme = org['nom_organisme'], adresse_organisme = org['adresse_organisme'], cp_organisme = org['cp_organisme'], ville_organisme = org['ville_organisme'],tel_organisme = org['tel_organisme'], fax_organisme = org['fax_organisme'], email_organisme = org['email_organisme'] )
